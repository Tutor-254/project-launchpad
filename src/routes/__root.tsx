...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Arcane — Master the craft of modern software and design" },
      {
        name: "description",
        content:
          "Arcane is a curated learning marketplace. Deep, professional courses in software, design, business, and languages — taught by working experts.",
      },
      { property: "og:title", content: "Arcane — Learn from working experts" },
      {
        property: "og:description",
        content: "A curated marketplace of professional-grade courses in software, design, and business.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    const { data: sub } = supabase.auth.onAuthStateChange(async (event, session) => {
      ...
      // For new OAuth sign-ins, check if onboarding is needed
